...
<%@ taglib uri="/WEB-INF/tld/struts-html.tld" prefix="html"%><%@ page import="java.io.*"%>
...
<%        }  %>
          ...
          <td  class="searchResult" width=120>
            <a class="link" target="tree" href="/jsp/WebTree.jsp?targetId=<%=java.net.URLEncoder.encode(myId)%>&amp;treeAction=highlight#<%=java.net.URLEncoder.encode(myId)%>">
