...
<img src="<%=request.getContextPath()%>/i/brandtype.gif" alt="brand type" border="0"></a></td>
<td valign="center" align="right"><a href="http://www.cancer.gov" target="_blank" alt="NCI Logo">
<img src="<%=request.getContextPath()%>/i/tagline_nologo.gif" alt="tag line no logo" border="0"></a></td></tr>
</table>
