...
//			pNode.addLeaf(csiNode);
	...
	throws Exception {
		String extraURLParameters = "&"+StringEscapeUtils.escapeHtml("PageId=DataElementsGroup")+"&"+StringEscapeUtils.escapeHtml("NOT_FIRST_DISPLAY=1")+"&"+StringEscapeUtils.escapeHtml("performQuery=yes");
