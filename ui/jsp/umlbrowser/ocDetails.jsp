...
<jsp:include page="mltitab_inc.jsp" flush="true">
	<jsp:param name="label" value="Object&nbsp;Class" />
      ...
      <table cellpadding="0" cellspacing="0" width="60%" align="center" border=0>
         ...
         <tr >
            <td  ><a class="link" href="#objectClass">Object Class Details</a></td>
            <td  ><a class="link" href="#concepts">Concepts</a></td>
            <td  ><a class="link" href="#alternateNames">Alternate Names</a></td>
            <td  ><a class="link" href="#alternateDefinitions">Alternate Definitions</a></td>   
         </tr>
         <tr >
           <td>&nbsp;</td>
         </tr>         
      ...
      <bean:define id="oc" name="<%=UmlBrowserFormConstants.OBJECT_CLASS%>"  scope="session"/>
                          ...
                          <table width="90%" align="center" cellpadding="4" cellspacing="1" class="OraBGAccentVeryDark">
                             ...
                             <logic:iterate id="comp" name="oc" type="gov.nih.nci.ncicb.cadsr.domain.ComponentConcept" property="conceptDerivationRule.componentConcepts" indexId="ccIndex" >                                 
                              <tr class="OraTabledata">
                                 ...
                                 <td class="OraFieldText">
                                      <bean:write name="comp" property="concept.preferredName"/>                                  
                                 </td>
                                 <td class="OraFieldText">
       ...
       <!-- end of concepts -->
          ...
          <table cellpadding="0" cellspacing="0" width="100%" align="center">
            ...
            <tr >
               <td width="100%" ><img height=1 src="<%=contextPath%>/i/beigedot.gif" width="90%" align=top border=0> </td>
            </tr>  
          </table>  
          ...
          <table cellpadding="0" cellspacing="0" width="100%" align="center">
            ...
            <tr >
               <td width="100%" ><img height=1 src="<%=contextPath%>/i/beigedot.gif" width="100%" align=top border=0> </td>
            </tr>  
          </table>            
          <table vAlign=top cellSpacing=1 cellPadding=1  width="90%" align=center border=0 class="OraBGAccentVeryDark">
            <TR class=OraTableColumnHeader>
