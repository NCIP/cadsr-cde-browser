      ...
      <logic:present name="<%=FormConstants.CRF%>">
        <table width="80%" align="center" cellpadding="1" cellspacing="1" border="0" class="OraBGAccentVeryDark">
          <tr class="OraTabledata">
            <td width="20%" class="OraTableColumnHeader" nowrap>
          ...
          <tr class="OraTabledata">
            <td width="20%" class="OraTableColumnHeader" nowrap>
              <bean:message key="cadsr.formbuilder.form.version"/>
            </td>
            <td class="OraFieldText" nowrap>
              ...
              <logic:notEmpty name="<%=FormConstants.DELETED_REFDOCS%>">
                <td align="right" class="OraFieldText" nowrap>
                  <html:select styleClass="Dropdown" property="<%=FormConstants.ADD_DELETED_REFDOC_IDSEQ%>">
                    <html:options collection="<%=FormConstants.DELETED_REFDOCS%>" property="docIDSeq" labelProperty="docName"/>
                  </html:select>
                </td>
          ...
          <logic:iterate id="refDoc" indexId="refDocIndex" name="<%=FormConstants.CRF%>" type="gov.nih.nci.ncicb.cadsr.resource.ReferenceDocument" property="refereceDocs">
            ...
            <table width="77%" align="center" cellpadding="0" cellspacing="0" border="0">
              <tr>
                ...
                <td align="right">
                  <html:link action="<%="/createReferenceDoc.do?"+NavigationConstants.METHOD_PARAM+"=gotoCreateReferenceDoc"%>" paramId="<%="selectedRefDocId"%>" paramName="refDocIndex">
                    <html:img src="<%="i/add.gif"%>" border="0" alt="Add new Reference Document"/>
                  </html:link>
                </td>
              </tr>
            ...
            <table width="80%" align="center" cellpadding="0" cellspacing="1" border="0" class="OraBGAccentVeryDark">
                          ...
                          <tr class="OraTableColumnHeader">
                            <td align="center">
                              <logic:notEqual value="<%= String.valueOf(refDocSize.intValue()-1) %>" name="refDocIndex">
                                <html:link action="<%="/manageReferenceDocs.do?"+NavigationConstants.METHOD_PARAM+"="+NavigationConstants.MOVE_REFDOC_DOWN%>" paramId="<%="selectedRefDocId"%>" paramName="refDocIndex">
                            ...
                            <td align="center">
                              <logic:notEqual value="<%= String.valueOf(0) %>" name="refDocIndex">
                                <html:link action="<%="/manageReferenceDocs.do?"+NavigationConstants.METHOD_PARAM+"="+NavigationConstants.MOVE_REFDOC_UP%>" paramId="<%="selectedRefDocId"%>" paramName="refDocIndex">
                                  <html:img src="<%="i/up.gif"%>" border="0" alt="Up"/>
                                </html:link>
                              </logic:notEqual>
                            </td>
                            <td align="center">
                              <html:link action="<%="/editReferenceDoc.do?"+NavigationConstants.METHOD_PARAM+"="+NavigationConstants.EDIT_REFDOC%>" paramId="<%="selectedRefDocId"%>" paramName="refDocIndex">
                                <html:img src="<%="i/edit.gif"%>" border="0" alt="Edit"/>
                              </html:link>
                            </td>
                            <td align="center">
                              <html:link action="<%="/manageReferenceDocs.do?"+NavigationConstants.METHOD_PARAM+"="+NavigationConstants.DELETE_REFDOC%>" paramId="<%="selectedRefDocId"%>" paramName="refDocIndex">
              ...
              <tr class="OraTabledata">
                <td class="OraTableColumnHeader" width="20%" nowrap>Type</td>
                <td class="OraFieldText" nowrap>
              ...
              <tr class="OraTabledata">
                <td class="OraTableColumnHeader" width="20%" nowrap>URL</td>
                <td class="OraFieldText" nowrap>
                  <bean:write name="refDoc" property="url"/>
                </td>
              </tr>
              <tr class="OraTabledata">
                <td class="OraTableColumnHeader" width="20%" nowrap>Description</td>
                <td class="OraFieldText" nowrap/>
              ...
              <tr class="OraTabledata">
                <td class="OraTableColumnHeader" width="20%" nowrap>Attachments</td>
                    ...
                    <tr class="OraTabledata">
                      <td class="OraFieldText" colspan="2">
                        <table width="10%" align="right" cellpadding="0" cellspacing="0" border="0" class="OraBGAccentVeryDark">
                          <tr class="OraTabledata">
                            <td align="center">
                              <html:link action="<%="/manageReferenceDocs.do?"+NavigationConstants.METHOD_PARAM+"=gotoUploadDocument"%>" paramId="<%="selectedRefDocId"%>" paramName="refDocIndex">
                    ...
                    <logic:iterate id="attachment" indexId="attachmentIndex" name="refDoc" type="gov.nih.nci.ncicb.cadsr.resource.Attachment" property="attachments">
                      <tr class="OraTabledata">
                        ...
                        <td class="OraFieldText" align="left">
                          <html:link action="<%="/viewReferenceDocAttchment.do?"+NavigationConstants.METHOD_PARAM+"=viewReferenceDocAttchment"%>" paramId="<%=FormConstants.REFERENCE_DOC_ATTACHMENT_NAME%>" paramName="attachment" paramProperty="name" target="_parent">
