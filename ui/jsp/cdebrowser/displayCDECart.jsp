		...
		<html:form action="/cdeCartAction.do">				
				...
				<table width="80%" align="center" cellpadding="1" cellspacing="1" border="0" class="OraBGAccentVeryDark">
					<tr class="OraTableColumnHeader">
						<logic:notEmpty name="<%=CaDSRConstants.CDE_CART%>" property="dataElements">
							<logic:present name="nciUser">
								<th>Save
									<input type="checkbox" name="saveAllChk" value="yes" onClick="ToggleSaveAll(this)"/>
								</th>
      							<th>Delete
      								<input type="checkbox" name="deleteAllChk" value="yes" onClick="ToggleDeleteAll(this)"/>
      							</th>    
							</logic:present>
							<logic:notPresent name="nciUser">
								<th>
									<input type="checkbox" name="allChk" value="yes" onClick="ToggleAll(this)" />
								</th>
							</logic:notPresent>
						</logic:notEmpty>
						<th>Long Name</th>
			...
			<table width="20%" align="center" cellpadding="1" cellspacing="1"
				...
				<tr>
					<td>
						<br>
						<html:link page="/cdeBrowse.jsp?PageId=DataElementsGroup">
