  ...
  <tr>
    ...
    <td align=right valign=top colspan=2 nowrap>
      <TABLE Cellpadding=0 Cellspacing=0 border=0 >
        <TR>
          <TD valign="TOP" align="CENTER" width="1%" colspan=1><A HREF="<%=frmURL%>formSearchAction.do" TARGET="_blank"><html:img page="/i/formicon.gif" alt="FormBuilder" border="0"  width="32" height="32" /></A><br><font color=brown face=verdana size=1>&nbsp;FormBuilder&nbsp;</font></TD>
