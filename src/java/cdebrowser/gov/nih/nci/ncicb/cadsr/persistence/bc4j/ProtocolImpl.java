...
public class ProtocolImpl extends EntityImpl  {
  ...
  protected static final int CONTEXTS = 28;
  protected static final int QUESTCONTENTSEXT = 29;
  ...
  public static synchronized EntityDefImpl getDefinitionObject() {
    if (mDefinitionObject == null) {
      mDefinitionObject = (EntityDefImpl)EntityDefImpl.findDefObject("gov.nih.nci.ncicb.cadsr.persistence.bc4j.Protocol");
    }
