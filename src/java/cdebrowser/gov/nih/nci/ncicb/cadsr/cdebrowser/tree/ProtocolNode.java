...
public class ProtocolNode  {
  ...
  public ProtocolNode(Protocol protoVO
    ...
    _protoTreeNode = new DefaultMutableTreeNode(
                  new WebNode(_myProtoVO.getProtoIdseq()
                     ...
                     ,"javascript:performAction('P_PARAM_TYPE=PROTOCOL&P_IDSEQ="+
  ...
  public List getCRFs() throws SQLException {
    ...
    try {
      pstmt =  
         (OraclePreparedStatement)_myDbUtil.getConnection().
                            prepareStatement(crfQueryStmt);
      ...
      while (rs.next()){
        DefaultMutableTreeNode crfNode = new DefaultMutableTreeNode(
          new WebNode(rs.getString(1)
                     ,rs.getString(2)
                     ,"javascript:performAction('P_PARAM_TYPE=CRF&P_IDSEQ="+
