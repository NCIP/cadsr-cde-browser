  ...
  private synchronized void retrieveProperties(String propFilename) throws Exception {
    ...
    if (!retrievedPropertiesHT.containsKey(propFilename)) {
      ...
      if (!result) {
        ...
        shareLabelWithAllTabsHT.put(propFilename,StringUtilities.booleanToStr(tp.getShareLabelWithAllTabs()));
    ...
    shareLabelWithAllTabs = StringUtilities.toBoolean(temp1);
