...
public class CDEBrowserBc4jModuleImpl extends ApplicationModuleImpl {
  private static Log log = LogFactory.getLog(CDEBrowserBc4jModuleImpl.class.getName());
  /**
  ...
  public ViewObject getMyValidValuesView(Object aVdIdseq)
    ...
    try {
      ...
      //view1 = (ValidValuesViewImpl)bc4jUtil.cloneViewObject(view);
  ...
  public DataElement findDataElementByCdeId(
    ...
    if (vw.first() == null) {
      ...
      view1.setWhereClause ("to_char(to_number(ltrim(substr(name,1,7)))) =  '"+
        cdeId+"' AND version= "+version);
