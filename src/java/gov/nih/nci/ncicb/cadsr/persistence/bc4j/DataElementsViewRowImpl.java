...
public class DataElementsViewRowImpl extends ViewRowImpl {
  ...
  protected static final int DATAELEMENTCONCEPTSROW = 21;
  ...
  public ValueDomain getValueDomain() {
    try {
      ...
      System.out.println(
        "Error in DataElementsViewRowImpl.getValueDomain(): " + e.getMessage());
  ...
  public Context getContext() {
    try {
      ...
      System.out.println(
        "Error in DataElementsViewRowImpl.getContext(): " + e.getMessage());
  ...
  public String getLongCDEName() {
    ...
    try {
      ...
      System.out.println(
        "Error in DataElementsViewRowImpl.getLongCDEName(): " + e.getMessage());
    }
  ...
  public String getCDEId() {
    ...
    try {
      ...
      System.out.println(
        "Error in DataElementsViewRowImpl.getCDEId(): " + e.getMessage());
  ...
  public DataElementConcept getDataElementConcept() {
    try {
      ...
      System.out.println(
        "Error in DataElementsViewRowImpl.getDataElementConcept(): " +
        e.getMessage());
  ...
  public List getReferenceDocs() {
    ...
    try {
      ...
      System.out.println(
        "Error in DataElementsViewRowImpl.getReferenceDocs(): " +
        e.getMessage());
    }
  ...
  public List getDesignations() {
    ...
    try {
      ...
      System.out.println(
        "Error in DataElementsViewRowImpl.getDesignations(): " +
        e.getMessage());
    }
