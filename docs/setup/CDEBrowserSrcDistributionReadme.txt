...
CDEBrowser_Windows_src_@cdebrowser.version.suffix@.zip and CDEBrowser_Unix_src_@cdebrowser.version.suffix@.tar.gz contains the complete
...
CDEBrowser @cdebrowser.version@ works with caDSR repository 3.0 and is not compatible with earlier versions of
caDSR repository
